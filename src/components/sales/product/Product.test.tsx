...
import  { SET_BASIC_PRODUCT_STATE } from '../../../store/basicproduct/types';
import product from '../../../store/basicproduct/reducers';
...
describe('Sales Product List', () => {
    ...
    it('Should be able to change view tabs to active/inactive', () => {
        ...
        expect(store.getState().basicproduct.activeTab).toBe('Inactive');
    });
